...
public class Lead1GraphView extends View {
    ...
    public Lead1GraphView(Context context) {
        super(context);
        init();
    }

    public Lead1GraphView(Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
        init();
    }
    ...
    private void init() {
        ...
        widthScale =(mPixelsPerCm) / Constants.SAMPLES_PER_CM;  // Samples per cm 200 for 25 mm/sec

        stringBuilder=new StringBuilder();

        // Samples per cm 100 for 25 mm/sec
    ...
    protected void onDraw(Canvas canvas) {
        ...
        if(mDrawPoints){
            ...
            for(int i=0;i<floatListpoints.size();i++){
                ...
                Log.d("plotting I Y value=", ""+newYValue);
             //   stringBuilder.append("\n"+floatListpoints.get(i)+"    "+newYValue+"     "+xValue+ "     "+newXvalue);
               // writeDatatoFile(stringBuilder.toString(),"Lead1_RealTime60bpm.txt");
