...
public class LeadaVFGraphView extends View {
    Paint mPaint;
    int mPixelsPerCm = 0;
    ...
    public LeadaVFGraphView(Context context) {
        super(context);
        init();
    }

    public LeadaVFGraphView(Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
        init();
    }
    ...
    protected void onDraw(Canvas canvas) {
        ...
        if(mDrawPoints){
            ...
            for(int i=0;i<floatListpoints.size();i++){
                ...
                Log.d("plotting aVF Y value=", ""+newYValue);
