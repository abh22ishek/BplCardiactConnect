...
public class Lead3GraphView extends View {
    ...
    public Lead3GraphView(Context context) {
        super(context);
        init();
    }

    public Lead3GraphView(Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
        init();
    }
    ...
    protected void onDraw(Canvas canvas) {
        ...
        if (mDrawPoints) {
            ...
            for (int i = 0; i < floatListpoints.size(); i++) {
                ...
                Log.d("plotting III Y value=", "" + newYValue);
