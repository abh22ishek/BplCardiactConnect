...
public class LeadV3GraphView extends View {
    ...
    public LeadV3GraphView(Context context) {
        super(context);
        init();
    }

    public LeadV3GraphView(Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
        init();
    }
    ...
    protected void onDraw(Canvas canvas) {
        ...
        if(mDrawPoints){
            ...
            for(int i=0;i<floatListpoints.size();i++){
                ...
                Log.d("plotting V3 Y value=", ""+newYValue);
