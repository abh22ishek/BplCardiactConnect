...
public class LeadV6GraphView extends View {
    ...
    public LeadV6GraphView(Context context) {
        super(context);
        init();
    }

    public LeadV6GraphView(Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
        init();
    }
    ...
    protected void onDraw(Canvas canvas) {
        ...
        if(mDrawPoints){
            ...
            for(int i=0;i<floatListpoints.size();i++){
                ...
                Log.d("plotting V6 Y value=", ""+newYValue);
