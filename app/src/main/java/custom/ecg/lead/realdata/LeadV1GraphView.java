...
public class LeadV1GraphView extends View {
    ...
    int countVal=0;
    public LeadV1GraphView(Context context) {
        super(context);
        init();
    }

    public LeadV1GraphView(Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
        init();
    }
    ...
    protected void onDraw(Canvas canvas) {
        ...
        if(mDrawPoints){
            ...
            for(int i=0;i<floatListpoints.size();i++){
                ...
                Log.d("plotting V1 Y value=", ""+newYValue);
    ...
    Runnable mRunnableCode = new Runnable() {
        ...
        public void run() {
            ...
            handler.postDelayed(mRunnableCode, 25);
        }
    };
