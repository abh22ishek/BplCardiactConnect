...
public class Lead2GraphView extends View {
    ...
    public Lead2GraphView(Context context) {
        super(context);
        init();
    }

    public Lead2GraphView(Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
        init();
    }
    ...
    protected void onDraw(Canvas canvas) {
        ...
        if(mDrawPoints){
            ...
            for(int i=0;i<floatListpoints.size();i++){
                ...
                Log.d("plotting II Y value=", ""+newYValue);
