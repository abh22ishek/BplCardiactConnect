...
public class LeadaVLGraphView extends View {
    Paint mPaint;
    int mPixelsPerCm = 0;
    ...
    int countVal=0;
    public LeadaVLGraphView(Context context) {
        super(context);
        init();
    }

    public LeadaVLGraphView(Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
        init();
    }
    ...
    protected void onDraw(Canvas canvas) {
        ...
        if(mDrawPoints){
            ...
            for(int i=0;i<floatListpoints.size();i++){
                ...
                Log.d("plotting aVL Y value=", ""+newYValue);
