...
public class LeadV5GraphView extends View {
    Paint mPaint;
    int mPixelsPerCm = 0;
    ...
    public LeadV5GraphView(Context context) {
        super(context);
        init();
    }

    public LeadV5GraphView(Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
        init();
    }
    ...
    protected void onDraw(Canvas canvas) {
        ...
        if(mDrawPoints){
            ...
            for(int i=0;i<floatListpoints.size();i++){
                ...
                Log.d("plotting V5 Y value=", ""+newYValue);
