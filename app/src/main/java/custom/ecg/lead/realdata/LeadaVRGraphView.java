...
public class LeadaVRGraphView extends View {
    ...
    public LeadaVRGraphView(Context context) {
        super(context);
        init();
    }

    public LeadaVRGraphView(Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
        init();
    }
    ...
    protected void onDraw(Canvas canvas) {
        ...
        if(mDrawPoints){
            ...
            for(int i=0;i<floatListpoints.size();i++){
                ...
                Log.d("plotting aVR Y value=", ""+newYValue);
              //  stringBuilder.append("\n"+floatListpoints.get(i)+"    "+newYValue+"     "+xValue+ "     "+newXvalue);
               //  writeDatatoFile(stringBuilder.toString(),"LeadaVR_RealTime60bpm.txt");
