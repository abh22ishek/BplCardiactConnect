...
public class LeadV2GraphView extends View {
    Paint mPaint;
    int mPixelsPerCm = 0;
    ...
    public LeadV2GraphView(Context context) {
        super(context);
        init();
    }

    public LeadV2GraphView(Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
        init();
    }
    ...
    protected void onDraw(Canvas canvas) {
        ...
        if(mDrawPoints){
            ...
            for(int i=0;i<floatListpoints.size();i++){
                ...
                Log.d("plotting V2 Y value=", ""+newYValue);
